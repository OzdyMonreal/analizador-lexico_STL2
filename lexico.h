...
class TipoSimbolo{
      public:
            ...
            static const int PARENIZQ= 14;//parentesis izquierdo "("
            static const int PARENDER= 15;//parentesis derecho ")"
            static const int CORCHETEIZQ= 16;//corchete izquierdo "{"
            static const int CORCHETEDER= 17;//corchete derecho "}"
